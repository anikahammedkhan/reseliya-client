...
const SingleProduct = ({ product }) => {
    const { _id, name, resale_price, original_price, image, brand, status } = product;
    return (
        <div className="card bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className='font-semibold text-lg'>Selling Status : <span className='text-green-400 text-2xl'>{status}</span></p>

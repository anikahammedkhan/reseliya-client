    ...
    return (
        <div className='my-12'>
            ...
            <div className="w-full max-w-md p-4 rounded-md shadow-2xl sm:p-8 mx-auto">
                <h2 className="mb-3 text-4xl font-semibold text-center">Login to your account</h2>
                <p className="text-sm text-center dark:text-gray-400">Don't have account?
                    <Link to="/register" className="focus:underline hover:underline text-green-500"> Register here</Link>
                </p>
                <div className="my-6 space-y-4">
                    <button onClick="" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400 hover:bg-green-200">
